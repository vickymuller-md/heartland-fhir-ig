...
| | |
| :--- | :--- |
| *Official URL*:https://heartlandprotocol.org/fhir/ImplementationGuide/heartland.fhir.us.protocol | *Version*:0.1.0 |
...
* [Background](background.md) — why HEARTLAND, the rural HF gap, evidence base
* [Risk Assessment](risk-assessment.md) — how to capture risk inputs and produce a tiered RiskAssessment
* [Implementation Tiers and Tracks](implementation.md) — facility tier assignment, patient track assignment, care plan structure
...
```json
{
  ...
  "url" : "https://heartlandprotocol.org/fhir/ImplementationGuide/heartland.fhir.us.protocol",
  "version" : "0.1.0",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://heartlandprotocol.org/fhir/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "exampleCanonical" : "https://heartlandprotocol.org/fhir/StructureDefinition/heartland-remote-monitoring-observation"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "https://heartlandprotocol.org/fhir/StructureDefinition/heartland-risk-assessment"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "https://heartlandprotocol.org/fhir/StructureDefinition/heartland-questionnaire-response"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "https://heartlandprotocol.org/fhir/StructureDefinition/heartland-patient"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
      ...
      "exampleCanonical" : "https://heartlandprotocol.org/fhir/StructureDefinition/heartland-careplan"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
