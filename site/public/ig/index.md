...
* **[Risk Assessment](risk-assessment.md)** — capture risk inputs and produce a tiered RiskAssessment
* **[Tiers and Tracks](implementation.md)** — facility tier assignment, patient track assignment, care plan structure
* **[Artifacts](artifacts.md)** — full list of profiles, extensions, value sets, code systems, and examples
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "CodeSystem/heartland-risk-score"
      },
      "name" : "HEARTLAND Risk Score Codes",
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "StructureDefinition/heartland-risk-score-total"
      },
      "name" : "HEARTLAND Risk Score Total",
