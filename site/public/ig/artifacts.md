# Artifacts Summary - HEARTLAND Protocol FHIR Implementation Guide v0.2.0
...
| | |
| :--- | :--- |
| [Example: Body Weight Observation with Red-Flag Threshold](Observation-ObservationExampleWeightRedFlag.md) | Body weight observation for PatientExampleRural captured via Track B (telephone-reported) showing a +1.2 kg gain in 24 hours. Reference range encodes a configurable program default rather than a protocol rule (>=0.9 kg in 24 hours triggers clinician outreach per the human filter principle). |
