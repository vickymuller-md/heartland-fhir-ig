...
| | |
| :--- | :--- |
| *Official URL*:https://heartlandprotocol.org/fhir/ValueSet/heartland-implementation-tier-vs | *Version*:0.1.0 |
...
```json
{
  ...
  "url" : "https://heartlandprotocol.org/fhir/ValueSet/heartland-implementation-tier-vs",
  "version" : "0.1.0",
